...
| Component | File | Purpose |
|-----------|------|---------|
| AppIconCache | `AppIconCache.kt` | Көлік жағындағы иконкалар кэші — 192x192 бастапқы PNG бір рет декодтайды, `prepareAll()` барлық иконкаларды фондық ағында өлшемін өзгертеді, `getPrepared()` ConcurrentHashMap-те O(1) іздеу, айналдыру кезінде I/O жоқ |
...
| **Қолданба иконкаларының кэші** | Көлік жағындағы кэш бастапқы PNG (192x192) дискіге сақтайды. `prepareAll()` APP_LIST келгеннен кейін барлық иконкаларды фондық ағында тор өлшеміне декодтайды және өлшемін өзгертеді. `getPrepared()` ConcurrentHashMap-те нөлдік шығынмен іздеу — корутиндерсіз, I/O-сыз, айналдыру кезінде декодтаусыз. |
| **Хабарландыруларды жабу/тазалау** | Көлік хабарландыру экранындағы әр элементті жабу батырмасы және "Барлығын тазалау" тақырыбы. Көлік телефонға NOTIFICATION_CLEAR / NOTIFICATION_CLEAR_ALL деректер хабарламаларын жібереді, телефон сәйкес Android хабарландыруларын тазалайды. |
